...
import com.rongshu.houseweb.entity.OssAliyunField;
...
public class OssAliyunUtil {
    ...
    @Resource(name="firstOssAliyuField")
    private OssAliyunField firstOssAliyuField;
    /**
     * 上传文件（选择默认的OSS配置）
     *
     * @param file
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            url = upload(firstOssAliyuField, getKey(firstOssAliyuField.getPrefix(),extFileName),
                    file.getInputStream());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public String upload(OssAliyunField ossAliyunField, MultipartFile file) {
        String url = null;
        try {
            url = upload(ossAliyunField, getKey(ossAliyunField.getPrefix(), null),
                    file.getInputStream());
        } catch (IOException e) {
            e.printStackTrace();
        }
