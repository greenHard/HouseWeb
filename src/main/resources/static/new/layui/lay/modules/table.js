layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    j.prototype.config = {
        ...
        var c = this, s = c.config, u = e[s.response.dataName] || [], f = [], p = [], v = [], m = function () {
            ...
            return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u, function (a, l) {
                ...
                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function (n, r) {
                    ...
                    var _c = c;
                    if (typeof(_c) == 'string') {
                        var _index = _c.indexOf(".");
                        if (_index > 0) {
                            var _key1 = _c.substring(0, _index);
                            var _key2 = _c.substring(_index + 1, _c.length);
                            p = l[_key1][_key2]
                        }
                    }
                    if (void 0 !== p && null !== p || (p = ""), !r.colGroup) {
                        var v = ['<td data-field="' + c + '" data-key="' + f + '" ' + function () {
                            ...
                            return r.toolbar ? function () {
                                var el_id_str = r.toolbar;
                                if ("function" === typeof r.toolbar) {
                                    el_id_str = r.toolbar(n)
                                }
                                return i(t(el_id_str).html() || "").render(n)
                            }() : r.templet ? function () {
        ...
        if (e && e.where) {
            for (var key in e.where) {
                e. where[key] = e. where[key].replace(/\s+/g,"");
                if (e.where[key] == "" || e.where[key] == null) {
                    delete e.where[key]
                }
            }
        }
