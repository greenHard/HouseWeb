var prefix = "/common/uppSysConfig"
var tableIns;
...
layui.use('table', function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'bankCode', title: '银行号', width:200}
            , {field: 'paraNameEn', title: '配置KEY值'}
            , {field: 'paraNameCn', title: '配置描述'}
    ...
    var $ = layui.$, active = {
        reload: function () {
            ...
            var paraNameEn = $('#search_paraNameEn');
            var paraValue = $('#search_paraValue');
            var paraNameCn = $('#search_paraNameCn');
            //执行重载
            table.reload('myTable', {
                ...
                , where: {
                    ...
                    paraNameEn: paraNameEn.val(),
                    paraValue: paraValue.val(),
                    paraNameCn: paraNameCn.val()
                }
            })
        }
    }
