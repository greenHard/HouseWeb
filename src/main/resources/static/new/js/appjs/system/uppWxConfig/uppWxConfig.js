...
layui.use('table', function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'accessToken', title: '微信基础平台token'}
            , {field: 'tokenExpire', title: 'TOKEN有效期'}
            , {field: 'jsTicket', title: 'JSAPI票据'}
            , {field: 'ticketExpire', title: 'TICKET有效期'}
