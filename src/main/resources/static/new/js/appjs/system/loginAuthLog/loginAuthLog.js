var prefix = "/system/loginAuthLog"
var tableIns;
...
layui.use('table', function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'merchantName', title: '商户',width:160}
            , {field: 'timestamp', title: '时间戳',width:240}
            , {field: 'callBackUrl', title: '回调地址'}
            , {field: 'userId', title: '用户id',width:110}
            , {field: 'sessionId', title: '登陆sessionID'}
            , {field: 'mobileNo', title: '手机号',width:130}
