var prefix = "/system/selfVoucherType"
var tableIns;
...
layui.use('table', function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            {field: 'voucherTypeCode', title: '券码类型编号', width:180},
            {field: 'voucherTypeName', title: '券码类型名称', width:150},
            {field: 'status', title: '状态', width:80},
            {field: 'jumpUrl', title: '跳转地址', width:300},
            {field: 'useDesc', title: '使用描述', width:150},
            {field: 'productNo', title: '产品编号', width:150, fixed: 'right'}
