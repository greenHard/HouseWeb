var prefix = "/system/selfVoucherLibrary"
var tableIns;
...
layui.use('table', function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'voucherId', title: '类别id', width:80}
            , {field: 'exportBatchId', title: '批次id', width:80}
            , {field: 'voucherCode', title: '券码号', width:200}
            ...
            , {field: 'status', title: '有效状态', width:100}
            , {field: 'useTime', title: '使用时间'}
            , {field: 'mobileNo', title: '使用手机号'}
